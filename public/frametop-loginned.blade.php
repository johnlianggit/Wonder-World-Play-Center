         ...
         <button class="navbar-toggle collapsed" type="button"  data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
			...
			<span class="icon-bar"></span>
		          ...
		          <div>
				     ...
				     <div class="cart">
					        <b>Trip</b> <span id="numcolor"><?php echo Session::get('CartTrip');?></span></br>
					        <b>People</b> <span id="numcolor"><?php echo Session::get('CartPeople');?></span> </br>
							<b>Total</b><span id="numcolor1"><?php echo '$'.number_format(Session::get('CartTotal'));?></span></br>
						    <form method="POST" action="details" novalidate>
					            <button type="submit" class="btn btn-xs btn-success" id="Details">Details</button>  
						    </form>
					 </div>
				  </div>        	  
	    </div>
